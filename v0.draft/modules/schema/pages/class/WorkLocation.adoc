...
WorkLocation -> StreetAddress: mainAddress


WorkLocation -> VoltageLevel: PowerSystemResources
...
| xref::class/BaseWork.adoc[`BaseWork`] | xref::class/BaseWork.adoc#WorkLocation[`WorkLocation`]
